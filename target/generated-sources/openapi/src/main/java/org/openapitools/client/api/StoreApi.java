...
public class StoreApi {
    ...
    public static class GetOrderByIdOper implements Oper {
         ...
         * @return OrderPetStore
         */
        public OrderPetStore executeAs(Function<Response, Response> handler) {
            Type type = new TypeToken<OrderPetStore>(){}.getType();
            return execute(handler).as(type);
        }
    ...
    public static class PlaceOrderOper implements Oper {
        ...
        public OrderPetStore executeAs(Function<Response, Response> handler) {
         ...
         /**
         * @param body (OrderPetStore) order placed for purchasing the pet (required)
         * @return operation
         */
        public PlaceOrderOper body(OrderPetStore body) {
