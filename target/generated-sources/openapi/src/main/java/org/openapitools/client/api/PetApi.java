...
public class PetApi {
    ...
    public static class AddPetOper implements Oper {
        ...
        public <T> T execute(Function<Response, T> handler) {
         ...
         /**
         * @param body (PetPetStore) Pet object that needs to be added to the store (required)
         * @return operation
         */
        public AddPetOper body(PetPetStore body) {
    ...
    public static class FindPetsByStatusOper implements Oper {
         ...
         * @return List&lt;PetPetStore&gt;
         */
        public List<PetPetStore> executeAs(Function<Response, Response> handler) {
            Type type = new TypeToken<List<PetPetStore>>(){}.getType();
    ...
    public static class GetPetByIdOper implements Oper {
         ...
         * @return PetPetStore
         */
        public PetPetStore executeAs(Function<Response, Response> handler) {
            Type type = new TypeToken<PetPetStore>(){}.getType();
            return execute(handler).as(type);
        }
    ...
    public static class UpdatePetOper implements Oper {
         ...
         * @return operation
         */
        public UpdatePetOper body(PetPetStore body) {
            reqSpec.setBody(body);
            return this;
        }
    ...
    public static class UploadFileOper implements Oper {
         ...
         * @return ApiResponsePetStore
         */
        public ApiResponsePetStore executeAs(Function<Response, Response> handler) {
            Type type = new TypeToken<ApiResponsePetStore>(){}.getType();
            return execute(handler).as(type);
        }
