...
public class UserApi {
    ...
    public static class CreateUserOper implements Oper {
        ...
        public <T> T execute(Function<Response, T> handler) {
         ...
         /**
         * @param body (UserPetStore) Created user object (required)
         * @return operation
         */
        public CreateUserOper body(UserPetStore body) {
    ...
    public static class CreateUsersWithArrayInputOper implements Oper {
        ...
        public <T> T execute(Function<Response, T> handler) {
         ...
         /**
         * @param body (List&lt;UserPetStore&gt;) List of user object (required)
         * @return operation
         */
        public CreateUsersWithArrayInputOper body(List<UserPetStore> body) {
            reqSpec.setBody(body);
            return this;
        }
    ...
    public static class CreateUsersWithListInputOper implements Oper {
         ...
         * @return operation
         */
        public CreateUsersWithListInputOper body(List<UserPetStore> body) {
            reqSpec.setBody(body);
            return this;
        }
    ...
    public static class GetUserByNameOper implements Oper {
         ...
         * @return UserPetStore
         */
        public UserPetStore executeAs(Function<Response, Response> handler) {
            Type type = new TypeToken<UserPetStore>(){}.getType();
    ...
    public static class UpdateUserOper implements Oper {
        ...
        public <T> T execute(Function<Response, T> handler) {
         ...
         /**
         * @param body (UserPetStore) Updated user object (required)
         * @return operation
         */
        public UpdateUserOper body(UserPetStore body) {
            reqSpec.setBody(body);
            return this;
        }
