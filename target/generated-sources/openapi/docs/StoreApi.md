...
# **getOrderById**
> OrderPetStore getOrderById(orderId)
...
[**OrderPetStore**](OrderPetStore.md)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**OrderPetStore**](OrderPetStore.md)| order placed for purchasing the pet |
