...
All URIs are relative to *https://virtserver.swaggerhub.com/poznanski.alex/SmartServerAPIOpenAPI2/1.0.0*
...
------------- | ------------- | ------------- | -------------
 **body** | [**PetPetStore**](PetPetStore.md)| Pet object that needs to be added to the store |
...
# **findPetsByStatus**
> List&lt;PetPetStore&gt; findPetsByStatus(status)
...
[**List&lt;PetPetStore&gt;**](PetPetStore.md)
...
# **findPetsByTags**
> List&lt;PetPetStore&gt; findPetsByTags(tags)
...
<a name="uploadFile"></a>
# **uploadFile**
> ApiResponsePetStore uploadFile(petId, additionalMetadata, file)
...
[**ApiResponsePetStore**](ApiResponsePetStore.md)
